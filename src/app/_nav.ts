...
export const navItems: INavData[] = [
  ...
  {
    name: 'Người dùng', url: '/personnels', icon: 'icon-bell',
    children: [
      { name: 'List người dùng', url: '/personnels/personnels', icon: 'icon-bell' },
    ]
  },
  {
    name: 'Hiển thị', url: '/displays', icon: 'icon-pencil',
    children: [
      { name: 'Banner', url: '/displays/banners', icon: 'icon-pencil' },
      { name: 'Tuyển dụng', url: '/displays/recruitments', icon: 'icon-pencil' },
      { name: 'Bài viết', url: '/displays/articlecs', icon: 'icon-pencil' },
    ]
  },
  {
    name: 'Thành phần công ty', url: '/compositions', icon: 'icon-puzzle',
    children: [
      { name: 'Phòng ban', url: '/compositions/departments', icon: 'icon-puzzle' },
      { name: 'Chức danh', url: '/compositions/jobtitles', icon: 'icon-puzzle' },
      { name: 'Chức vụ', url: '/compositions/jobpositions', icon: 'icon-puzzle' },
      { name: 'Ngành nghề', url: '/compositions/careers', icon: 'icon-puzzle' },
      { name: 'Tỉnh/Thành phố', url: '/compositions/cityprovinces', icon: 'icon-puzzle' },
    ]
  },
  {
    name: 'Ứng tuyển', url: '/candidates', icon: 'icon-star',
    children: [
      { name: 'List ứng viên', url: '/candidates/candidates', icon: 'icon-star' },
    ]
  },
