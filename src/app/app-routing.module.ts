...
export const routes: Routes = [
  ...
  { path: 'register', component: RegisterComponent, data: { title: 'Register Page' } },
  {
    ...
    children: [
      ...
      { path: 'personnels', loadChildren: () => import('./personnels/personnels.module').then(m => m.PersonnelsModule) },
      { path: 'compositions', loadChildren: () => import('./compositions/compositions.module').then(m => m.CompositionsModule) },
      { path: 'displays', loadChildren: () => import('./displays/displays.module').then(m => m.DisplaysModule) },
